...
1. Create a new mod folder for your furniture mod and set up everything for your desired furniture, such as the appended SWF file you created, furniture_effects.gon.patch, and localization combined.csv.append.
(For an example of the fla/SWF and other files, refer to the files provided in the example zip).
