...
#define RVA_PACKED_FILE_LOAD 0x0099FF50U // RVA of the packed-file loader, (hooked to intercept furniture_info.data after the game loads it)...
...
#define RVA_FURNITURE_EDITOR_UPDATE 0x001AF260U // RVA of the furniture editor update function, (hooked so we can capture the selected row)...
...
#define RVA_FURNITURE_PAYLOAD_LOOKUP 0x001B09C0U // RVA of the helper that resolves a furniture name in the payload map and returns the payload bytes...
#define RVA_DEBUG_TEXT_ADD 0x009B5250U // RVA of the single-line debug-text display helper used by the furniture editor help overlay...
...
#define RVA_DEBUG_TEXT_ADD_PAIR 0x00952600U // RVA of the label/value debug-text display helper used by the current furniture piece line...
...
#define RVA_DEBUG_CONSOLE_VISIBILITY_UPDATE 0x00A11CD0U // RVA of the debug-console visibility updater, used to force the overlay visible on editor entry...
...
#define RVA_GAME_ALLOCATE 0x00052A40U // RVA of the game allocator used by std::string storage...
#define RVA_MSVC_STRING_DESTRUCT 0x00052780U // RVA of the game std::string destructor used by debug-text calls...
...
#define RVA_SHOP_INIT 0x00794CF0U // Used to remember the Jack shop instance for test hotkeys...
#define SHOP_INIT_STOLEN_BYTES 16 // Hook overwrite size at RVA_SHOP_INIT...
#define RVA_SHOP_UPDATE 0x00797EA0U // RVA of Shop::update, used to poll Jack shop test hotkeys while the shop is open...
#define SHOP_UPDATE_STOLEN_BYTES 16 // Hook overwrite size at RVA_SHOP_UPDATE...
#define RVA_SHOP_INIT_SHOP 0x00796070U // RVA of Shop::initShop, kept resolved for compatibility/debugging but not used for live rerolls...
#define RVA_SHOP_REFRESH_SHOP_ITEM 0x007988E0U // RVA of Shop::refresh_shopitem, used to rebuild the visible button after a test replacement...
#define RVA_FURNITURE_PRICE_LOOKUP 0x007B95D0U // RVA of the furniture price helper used by vanilla shop item rolling...
#define RVA_GLOBAL_FURNITURE_EFFECTS_PTR 0x013C79D0U // RVA of the global furniture-effects pointer passed to the price helper...
